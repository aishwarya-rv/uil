...
dag = DAG(
    ...
    description='Account portfolio UIL code',
...
def validation_schema():
    ...
    try:
        ...
        if e.response['Error']['Code'] == "404":
            #Yesterday's file doesn't exist
            print("Yesterday's file does not exist.")
            return True
    ...
    if today_schema == yesterday_schema:
        print("Both the schemas are identical.")
        return True
    else:
        print("Both the schemas are different.")
